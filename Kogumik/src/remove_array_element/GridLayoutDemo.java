...
public class GridLayoutDemo extends JFrame {
    ...
    GridLayout experimentLayout = new GridLayout(2,0,0, 0);
    ...
    public void addComponentsToPane(final Container pane) throws IOException {
        ...
        Image img =  ImageIO.read(getClass().getResource("D:/temp/kaardid/2/joker/jokerb.png"));
        int width=Kaart1.getIconWidth();
        int height=Kaart1.getIconHeight();
        
        
        
        //Set up components preferred size
        JButton b = new JButton(Kaart1);
        ...
        jb.setBorder (null);
        Dimension nupusuurus = jb.getPreferredSize();
        nupusuurus.height=height;
        nupusuurus.width=width;
        jb.setSize(nupusuurus);
        compsToExperiment.add(jb);
        
        JButton jb2 = new JButton(Kaart1);
